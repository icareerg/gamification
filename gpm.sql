...
--
-- Host: localhost:8889
-- Generation Time: 2016-08-19 16:13:16
-- 服务器版本： 5.5.42
-- PHP Version: 5.6.10
...
INSERT INTO `rule_duration` (`rule_id`, `level_id`, `duration_id`, `percentage`) VALUES
(1, 1, 1, '0.5000');
...
--
ALTER TABLE `rule_conduct`
  MODIFY `rule_id` int(10) NOT NULL AUTO_INCREMENT COMMENT '主键',AUTO_INCREMENT=3;
--
