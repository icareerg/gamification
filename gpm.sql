...
--
-- Host: localhost:8889
-- Generation Time: 2016-09-02 11:47:53
-- 服务器版本： 5.5.42
-- PHP Version: 5.6.10
...
CREATE TABLE `bug` (
  `bug_id` int(10) NOT NULL COMMENT '缺陷ID',
  `player_id` int(10) NOT NULL COMMENT '玩家ID',
  `happen_time` int(10) NOT NULL COMMENT '发生时间',
  `severity` tinyint(1) NOT NULL COMMENT '严重程度：1轻微；2一般；3严重'
...
INSERT INTO `bug` (`bug_id`, `player_id`, `happen_time`, `severity`) VALUES
(1, 1, 1472710488, 1),
(10, 1, 1472781120, 2),
(11, 1, 1473436800, 2),
(12, 5, 1472745600, 3);
...
(1, '陈鹏威', 'd770f95f4268da92bb076b161dfeb640', 1, 0, -250),
...
--
ALTER TABLE `bug`
  MODIFY `bug_id` int(10) NOT NULL AUTO_INCREMENT COMMENT '缺陷ID',AUTO_INCREMENT=13;
--
